...
class Audio2FaceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PushAudio = channel.unary_unary(
                '/meta_assistant.services.grpc.Audio2Face/PushAudio',
        ...
        self.PushAudioStream = channel.stream_unary(
                '/meta_assistant.services.grpc.Audio2Face/PushAudioStream',
...
def add_Audio2FaceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'meta_assistant.services.grpc.Audio2Face', rpc_method_handlers)
...
class Audio2Face(object):
    ...
    def PushAudio(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/meta_assistant.services.grpc.Audio2Face/PushAudio',
    ...
    def PushAudioStream(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/meta_assistant.services.grpc.Audio2Face/PushAudioStream',
